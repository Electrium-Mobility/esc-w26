...
This repository contains all the firmware and hardware for Electrium Mobility's 2026 ESC, which is a 36V/15A 3-phase BLDC motor controller built on the STSPIN32G4 SiP's integrated gate driver and STM32G4 MCU, supporting 6-step commutation and FOC!
